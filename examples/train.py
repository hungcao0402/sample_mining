...
from hhcl.models.cm_v2 import ClusterMemory
...
def main_worker(args):
    wandb.login(key='ff5b52a33a239091a7ff2025e6598b0d9827e976')
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if (epoch + 1) % args.eval_step == 0 or (epoch == args.epochs - 1):
            mAP = evaluator.evaluate(test_loader, dataset.query, dataset.gallery, run, cmc_flag=False)
...
if __name__ == '__main__':
    ...
    #sample strategy
    parser.add_argument('--negative_sample', type=str, default='hard')
    parser.add_argument('--positive_sample', type=str, default='hard')
